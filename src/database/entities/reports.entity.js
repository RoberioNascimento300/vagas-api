...
var ReportsEntity = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('tb_reports')];
    ...
    var ReportsEntity = _classThis = /** @class */ (function () {
        function ReportsEntity_1() {
        ...
        return ReportsEntity_1;
    }());
    __setFunctionName(_classThis, "ReportsEntity");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)('uuid')];
        _job_decorators = [(0, typeorm_1.ManyToOne)(function () { return jobs_entity_1.JobsEntity; }), (0, typeorm_1.JoinColumn)({ name: 'job_id' })];
        _job_id_decorators = [(0, typeorm_1.Column)()];
        _user_decorators = [(0, typeorm_1.ManyToOne)(function () { return users_entity_1.UsersEntity; }), (0, typeorm_1.JoinColumn)({ name: 'user_id' })];
        ...
        ReportsEntity = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ReportsEntity = _classThis;
}();
