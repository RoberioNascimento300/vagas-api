...
var AlertEntity = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('tb_alerts')];
    ...
    (function () {
        ...
        _userId_decorators = [(0, typeorm_1.Column)({ name: 'user_id', nullable: false })];
        _keyword_decorators = [(0, typeorm_1.Column)()];
