...
exports.RecoveryPasswordSwagger = void 0;
var swagger_1 = require("@nestjs/swagger");
var RecoveryPasswordSwagger = function () {
    var _a;
    var _instanceExtraInitializers = [];
    var _message_decorators;
    var _message_initializers = [];
    return _a = /** @class */ (function () {
            function RecoveryPasswordSwagger() {
                this.message = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _message_initializers, void 0));
            }
            return RecoveryPasswordSwagger;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _message_decorators = [(0, swagger_1.ApiProperty)({
                    example: 'Caso esse e-mail esteja cadastrado no sistema, será encaminhado para ele uma mensagem de orientação sobre os próximos passos para a redefinição da senha.',
                })];
...
exports.RecoveryPasswordSwagger = RecoveryPasswordSwagger;
