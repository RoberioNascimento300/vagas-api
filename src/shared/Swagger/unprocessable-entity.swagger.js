...
exports.UnprocessableEntitySwagger = void 0;
var swagger_1 = require("@nestjs/swagger");
var UnprocessableEntitySwagger = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function UnprocessableEntitySwagger() {
            ...
            return UnprocessableEntitySwagger;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _statusCode_decorators = [(0, swagger_1.ApiProperty)({ example: 422 })];
            _message_decorators = [(0, swagger_1.ApiProperty)({ example: 'invalid input syntax for type uuid:' })];
            _error_decorators = [(0, swagger_1.ApiProperty)({ example: 'Unprocessable Entity' })];
...
exports.UnprocessableEntitySwagger = UnprocessableEntitySwagger;
