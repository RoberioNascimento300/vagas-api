...
var AppService = function () {
    ...
    var AppService = _classThis = /** @class */ (function () {
        function AppService_1(mailService, userRepository) {
            this.mailService = mailService;
            this.userRepository = userRepository;
        }
        AppService_1.prototype.getAppStatus = function (baseUrl) {
        ...
        AppService_1.prototype.getHealthCheck = function () {
            return __awaiter(this, void 0, void 0, function () {
                var databaseStatus, mailerStatus, data;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.checkDatabase()];
                        case 1:
                            databaseStatus = _a.sent();
                            return [4 /*yield*/, this.checkEmail()];
                        case 2:
                            mailerStatus = _a.sent();
                            data = {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            options = {
                                ...
                                take: 10,
                                orderByColumn: 'id',
                                order: pagination_1.Order.ASC
                            };
                            return [4 /*yield*/, this.userRepository.getAllUsers(options)];
                        case 1:
                            allUsers = _a.sent();
        ...
        AppService_1.prototype.checkEmail = function () {
            return __awaiter(this, void 0, void 0, function () {
                var error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
