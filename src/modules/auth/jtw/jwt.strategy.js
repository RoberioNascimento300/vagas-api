...
var JwtStrategy = function () {
    ...
    var JwtStrategy = _classThis = /** @class */ (function (_super) {
        ...
        function JwtStrategy_1(userRepository, companyRepository) {
            ...
            _this.companyRepository = companyRepository;
            return _this;
        }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.companyRepository
                                    .findOneByEmail(payload.email)
                                    .catch(handle_error_util_1.handleError)];
                        case 2:
                            user = _a.sent();
                        ...
                        case 3:
                            if (!user) {
                                throw new common_1.UnauthorizedException('User not found or not authorized!');
                            }
                            if (user) {
