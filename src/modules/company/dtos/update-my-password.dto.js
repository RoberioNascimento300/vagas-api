...
var match_decorator_1 = require("../dtos/decorators/match.decorator");
var UpdateMyPasswordDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _oldPassword_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'Senha atual',
                    example: 'Abcd@1234',
                }), (0, class_validator_1.IsString)({ message: 'O campo oldPassword deve ser uma string' }), (0, class_validator_1.IsNotEmpty)({ message: "O campo 'oldPassword' não pode ficar vazio" })];
            _password_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'Nova senha de login',
                    example: 'Abcd@1234',
                }), (0, class_validator_1.IsString)({ message: 'O campo password deve ser uma string' }), (0, class_validator_1.IsNotEmpty)({ message: "O campo 'password' não pode ficar vazio" }), (0, class_validator_1.Length)(8, 50), (0, class_validator_1.Matches)(/((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$/, {
                    message: 'A senha precisa ter no mínimo 8 caracteres, máximo de 50, uma letra maiúscula, um número e um símbolo.',
                })];
            _confirmNewPassword_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'Confirmação da nova senha de login',
                    example: 'Abcd@1234',
                }), (0, class_validator_1.IsString)({ message: 'O campo confirmNewPassword deve ser uma string' }), (0, class_validator_1.IsNotEmpty)({ message: "O campo 'confirmNewPassword' não pode ficar vazio" }), (0, class_validator_1.Length)(8, 50), (0, class_validator_1.Matches)(/((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$/, {
                    message: 'A senha precisa ter no mínimo 8 caracteres, máximo de 50, uma letra maiúscula, um número e um símbolo.',
                })];
...
var CreatePasswordHashDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _password_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'Senha de login (8 a 50 caracteres, com pelo menos uma letra maiúscula, um número e um caractere especial)',
                    example: 'Abcd@1234',
                }), (0, class_validator_1.IsString)({ message: 'O campo password deve ser uma string' }), (0, class_validator_1.IsNotEmpty)({ message: "O campo 'password' não pode ficar vazio" }), (0, class_validator_1.Length)(8, 50), (0, class_validator_1.Matches)(/((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$/, {
                    message: 'A senha precisa ter no mínimo 8 caracteres, máximo de 50, uma letra maiúscula, um número e um símbolo.',
                })];
            _confirmPassword_decorators = [(0, swagger_1.ApiProperty)({
                    ...
                    example: 'Abcd@1234',
                }), (0, class_validator_1.IsString)({ message: 'O campo confirmPassword deve ser uma string' }), (0, class_validator_1.IsNotEmpty)({ message: "O campo 'confirmPassword' não pode ficar vazio" }), (0, match_decorator_1.Match)('password', {
                    message: 'Os campos de senha precisam ser idênticos.',
                })];
            _recoverPasswordToken_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'Token de recuperação de senha (opcional)',
                    example: 'algum UUID aleatório',
                }), (0, class_validator_1.IsString)({ message: 'O campo recoverPasswordToken deve ser uma string' })];
            __esDecorate(null, null, _password_decorators, { kind: "field", name: "password", static: false, private: false, access: { has: function (obj) { return "password" in obj; }, get: function (obj) { return obj.password; }, set: function (obj, value) { obj.password = value; } }, metadata: _metadata }, _password_initializers, _instanceExtraInitializers);
