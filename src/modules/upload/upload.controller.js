...
var upload_swagger_1 = require("../../../../../../../../../src/shared/Swagger/decorators/upload/upload.swagger");
var UploadController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Upload'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.UseGuards)((0, passport_1.AuthGuard)()), (0, common_1.Controller)('upload')];
    ...
    var UploadController = _classThis = /** @class */ (function () {
        function UploadController_1(fileUploadService) {
            this.fileUploadService = (__runInitializers(this, _instanceExtraInitializers), fileUploadService);
        }
        UploadController_1.prototype.upload = function (file) {
    ...
    (function () {
        ...
        _upload_decorators = [(0, upload_swagger_1.UploadSwagger)(), (0, common_1.Post)(), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file'))];
