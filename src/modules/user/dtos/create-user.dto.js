...
var userRole_1 = require("../../../shared/utils/userRole/userRole");
...
var CreateUserDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _name_decorators = [(0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.MaxLength)(50), (0, class_validator_1.IsString)(), (0, swagger_1.ApiProperty)({
                    description: 'Nome do usuário.',
                    example: 'Amaro Francisco',
                })];
            _email_decorators = [(0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.IsEmail)(), (0, class_validator_1.IsString)(), (0, swagger_1.ApiProperty)({
                    description: 'E-mail do usuário.',
                    example: 'johnsnow@outlook.com',
                })];
            _password_decorators = [(0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.IsString)(), (0, class_validator_1.Matches)(/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*\W)[a-zA-Z\d\W]{8,}$/, {
                    message: 'Senha inválida. Deve conter pelo menos 8 caracteres, uma letra maiúscula, uma letra minúscula, um número e um caractere especial.',
                }), (0, swagger_1.ApiProperty)({
                    description: 'Senha de Login',
                    example: 'Abcd@1234',
                })];
            _confirmPassword_decorators = [(0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.IsString)(), (0, swagger_1.ApiProperty)({
            ...
            _type_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(userRole_1.UserRole)];
